function K = genScaleKOmega(mask, greyImg, sigma1, sigma2, p, KernelFcn)
    ...
    % if cOmega >= q * nTotal
        parfor i = 1:cOmega
            ...
            K(:, :, i) = scaleReKernel(xLoc, DLoc, tempGreyImg(:, i), DgreyImg, sigma1, sigma2, p, KernelFcn, size(mask))';
